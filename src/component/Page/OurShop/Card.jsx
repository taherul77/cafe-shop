    ...
    <>
      <div className="col-span-12 lg:col-span-3 bg-white">
        <div
          ...
          className="hover:border rounded-md cursor-pointer"
        >
          ...
          <div className=" sm:mb-5 lg:mb-0 lg:text-center pt-5 pb-12 space-y-3 border border-gray-200 relative">
            ...
            <button>
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-12 h-12 absolute p-4 rounded-full bottom-[-20px] text-white bg-[#CA8E46] left-1/2 transform -translate-x-1/2"
              >
                <path
                  strokeLinecap="round"
